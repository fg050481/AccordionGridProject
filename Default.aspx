...
(function () {
    ...
    /* ── Load data injected by code-behind ───────────────────────
       ClientScript.RegisterStartupScript sets window.poaTemplatesData
       to the JSON array before this <script> runs.
    ──────────────────────────────────────────────────────────── */
    if (window.poaTemplatesData && window.poaTemplatesData.length) {
        grid.loadData(window.poaTemplatesData);
    } else {
        log('err', 'window.poaTemplatesData is empty — check RegisterStartupScript.');
    }
